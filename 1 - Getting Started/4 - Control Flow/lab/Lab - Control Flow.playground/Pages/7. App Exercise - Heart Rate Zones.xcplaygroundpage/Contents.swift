...
switch currentHR {
case 0...99:
    print ("You are not doing any exercise")
case 100...120:
    print ("You are in the Very Light zone. Activity in this zone helps with recovery.")
case 121...140:
    print ("You are in the Light zone. Activity is this zone helps improve basic endurance and fat burning.")
case 141...160:
...
case 181...200:
    print ("You are in teh Maximum zone. Activity in this zone helps fit atheles develop speed")
default:
